    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mt-4">Lineer Kızak ve Arabalar</h1>
          <p className="text-gray-600 mt-2">Hassas lineer kızak ve araba sistemleri</p>
        </div>
      </div>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-lg shadow-sm p-8">
          <div className="text-center">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Lineer Kızak ve Arabalar</h2>
