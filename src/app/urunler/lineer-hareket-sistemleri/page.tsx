      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center space-x-4">
            <Link href="/urunler" className="flex items-center text-[#00b9bf] hover:text-[#009aa0] transition-colors">
              <ArrowLeft className="w-5 h-5 mr-2" />
              Ürünlere Dön
            </Link>
          </div>
          <h1 className="text-3xl font-bold text-gray-900 mt-4">Lineer Hareket Sistemleri</h1>
          <p className="text-gray-600 mt-2">Yüksek hassasiyet ve dayanıklılık sunan lineer destek ürünleri</p>
        </div>
      </div>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-lg shadow-sm p-8">
          <div className="text-center">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Lineer Hareket Sistemleri</h2>
