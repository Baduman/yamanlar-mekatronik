...
const brands = [
  {
    ...
    description: 'Endüstriyel mekatronik ve otomasyon çözümlerinde güvenilir partner. Yüksek kaliteli ürünleri ile üretim süreçlerinde verimliliği artıran çözümler sunar.',
    website: '#'
  },
  {
    name: 'HIWIN',
    image: '/homePageImage/Marka2.png',
    description: 'Dünya çapında lineer hareket sistemleri ve otomasyon çözümlerinde lider marka. Yüksek hassasiyet ve dayanıklılık sunan ürünleri ile endüstriyel uygulamalarda tercih edilen güvenilir partner.',
    website: 'https://www.hiwin.com'
  },
  {
    name: 'YOSO',
    image: '/homePageImage/Marka3.jpeg',
    description: 'Mekatronik ve lineer hareket sistemlerinde yenilikçi çözümler. Modern teknoloji ve kaliteli üretim ile endüstriyel uygulamalarda güvenilir performans sağlar.',
    website: '#'
  }
];
    ...
    <section className="w-full bg-gray-50 py-16">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">
          Endüstriyel mühendislik çözümlerinde dünya lideri markalarla çalışarak, 
          müşterilerimize en yüksek kalitede ürün ve hizmet sunuyoruz.
        </p>
